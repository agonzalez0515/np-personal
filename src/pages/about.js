...
const About = () => (
  <div className= "container" css={{display: `grid`, gridColumnGap:`20px`, gridTemplateColumns: `400px`}}>
    <h2 className="author" css={{gridColumn: `span 4`, justifySelf: `start`}}> About </h2>
    <h2 className="author" css={{gridColumn: `span 4`, justifySelf: `start`}}> Me </h2>
    <section className="bio" css={{gridColumn: `span 2`}}>
    ...
    <aside css={{alignSelf: `center`}}>
      <img src={profile} alt="picture of Natalia Provatas" css={{width: `350px`, display: `block`}} />
    </aside>
  </div>
)
